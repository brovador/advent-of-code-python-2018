...
def main():
	...
	sleeping_minutes = { k: Counter(v).most_common(1) for k, v in sleeping_minutes.items() }
	sleeping_minutes = max(sleeping_minutes.items(), key = lambda kv: kv[1][0][1])
	print sleeping_minutes[0] * sleeping_minutes[1][0][0]
